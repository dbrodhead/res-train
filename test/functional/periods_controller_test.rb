...
class PeriodsControllerTest < ActionController::TestCase
  ...
  test "should create period" do
    assert_difference('Period.count') do
      post :create, period: { etime: @period.etime, name: @period.name, number: @period.number, stime: @period.stime }
    end
  ...
  test "should update period" do
    put :update, id: @period, period: { etime: @period.etime, name: @period.name, number: @period.number, stime: @period.stime }
    assert_redirected_to period_path(assigns(:period))
  end
