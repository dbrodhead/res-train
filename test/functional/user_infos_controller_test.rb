...
class UserInfosControllerTest < ActionController::TestCase
  ...
  test "should create user_info" do
    assert_difference('UserInfo.count') do
      post :create, user_info: { dept_id: @user_info.dept_id, fname: @user_info.fname, lname: @user_info.lname, rank: @user_info.rank, trade_id: @user_info.trade_id, user_id: @user_info.user_id }
    end
  ...
  test "should update user_info" do
    put :update, id: @user_info, user_info: { dept_id: @user_info.dept_id, fname: @user_info.fname, lname: @user_info.lname, rank: @user_info.rank, trade_id: @user_info.trade_id, user_id: @user_info.user_id }
    assert_redirected_to user_info_path(assigns(:user_info))
  end
