== CARLETON Training
This site is being designed to handle the training schedule for a Canadian Forces Naval Reserve Division(NRD). HMCS CARLETON (Ottawa NRD) has ~200 sailors spanning 10 different trades(professions). Each trade follows it's own training schedule maintained and updated by their departmental training coordinator. All of the trades are supervised by the Training Department. 
